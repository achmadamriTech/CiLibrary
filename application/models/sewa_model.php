<?php
    ...
    class Sewa_Model extends CI_Model{
         // Url Buku
         private $svcUrl = "http://localhost:8888/sewa/detail/";
         private $svcUrls = "http://localhost:8888/sewa/";
        ...
        public function editSewa($sewaId) {
            ...
            curl_setopt_array($svcPut, array(
                CURLOPT_URL => $this->svcUrls . $sewaId,
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_FOLLOWLOCATION => true,
                CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
    ...
    public function hapusSewa($sewaId) {
        //Mengakses Web Service menggunakan HTTP Request
        // $api_url = "http://localhost:8081/buku/$idBuku";
